...
CREATE TABLE IF NOT EXISTS config_changes (
    ...
    change_type TEXT NOT NULL CHECK(change_type IN ('agent_create', 'agent_delete', 'binding_create', 'binding_delete', 'channel_config', 'skill_pack_create', 'skill_pack_delete', 'job_create', 'job_delete', 'directory_create', 'config_update', 'feishu_group_bind', 'feishu_group_unbind', 'other')),
    target_type TEXT NOT NULL CHECK(target_type IN ('agents.list', 'bindings', 'channels.feishu', 'channels.feishu.groups', 'skill_packs', 'jobs', 'directories', 'gateway', 'departments', 'other')),
