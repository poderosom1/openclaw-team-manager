...
export interface ConfigChange {
  id: string;
  session_id: string;
  change_type: 'agent_create' | 'agent_delete' | 'binding_create' | 'binding_delete' | 'channel_config' | 'skill_pack_create' | 'skill_pack_delete' | 'job_create' | 'job_delete' | 'directory_create' | 'config_update' | 'feishu_group_bind' | 'feishu_group_unbind' | 'feishu_pairing_approve' | 'other';
  target_type: 'agents.list' | 'bindings' | 'channels.feishu' | 'channels.feishu.groups' | 'skill_packs' | 'jobs' | 'directories' | 'gateway' | 'departments' | 'credentials' | 'other';
  target_path: string;
